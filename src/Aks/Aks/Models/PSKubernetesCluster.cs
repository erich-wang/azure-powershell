...
namespace Microsoft.Azure.Commands.Aks.Models
{
    public class PSKubernetesCluster : PSResource
    {
        ...
        public PSKubernetesCluster(string location, string id = default(string), string name = default(string),
            ...
            IList<PSManagedClusterAgentPoolProfile> agentPoolProfiles =
                default(IList<PSManagedClusterAgentPoolProfile>),
        ...
        /// </summary>
        public IList<PSManagedClusterAgentPoolProfile> AgentPoolProfiles { get; set; }
